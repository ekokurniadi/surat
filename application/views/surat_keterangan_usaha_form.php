  ...
  <div class="row">
      <div class="col-12 col-md-12 col-lg-12">
        ...
        <form action="<?php echo $action; ?>" method="post" class="form-horizontal">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="alamat_tempat_tinggal">Nama Usaha <?php echo form_error('alamat_tempat_tinggal') ?></label>
                <div class="col-sm-12">
                    <textarea class="form-control" rows="3" name="usaha" id="usaha" placeholder="Nama Usaha"><?php echo $usaha; ?></textarea>
                </div>
              </div>
