  ...
  <div class="row">
      <div class="col-12 col-md-12 col-lg-12">
        ...
        <div class="card-header">
            <h4>Form Surat Keterangan Belum Memiliki Rumah </h4>
        </div>
        <form action="<?php echo $action; ?>" method="post" class="form-horizontal">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="date">Tanggal Surat <?php echo form_error('tanggal_surat_pengantar') ?></label>
                <div class="col-sm-12">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="varchar">Kewarganegaraan <?php echo form_error('pekerjaan') ?></label>
                <div class="col-sm-12">
	    ...
	    <a href="<?php echo site_url('surat_keterangan_belum_memiliki_rumah') ?>" class="btn btn-icon icon-left btn-success">Cancel</a>
